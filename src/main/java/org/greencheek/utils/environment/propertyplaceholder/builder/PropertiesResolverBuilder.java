...
public interface PropertiesResolverBuilder {
    ...
    public PropertiesResolverBuilder setResolvingSystemProperties(boolean b);
    public boolean isResolvingSystemProperties();

    public PropertiesResolverBuilder setResolvingEnvironmentVariables(boolean b);
    public boolean isResolvingEnvrionmentVariables();


    public PropertiesResolverBuilder setExtensionForPropertiesFile( String suffix);
     ...
     * @return The builder
     */
    public PropertiesResolverBuilder setVariablesUsedForSwitchingConfiguration(List<List<String>> var);
     ...
     * @return The builder
     */
    public PropertiesResolverBuilder setVariablesUsedForSwitchingConfiguration(String[] csv);
