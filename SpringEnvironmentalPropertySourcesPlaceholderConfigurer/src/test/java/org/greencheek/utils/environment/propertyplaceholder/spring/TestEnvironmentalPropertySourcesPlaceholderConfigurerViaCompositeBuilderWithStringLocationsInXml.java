 ...
 * Time: 13:25
 */
public class TestEnvironmentalPropertySourcesPlaceholderConfigurerViaCompositeBuilderWithStringLocationsInXml {
    ...
    public void testPropertyResolved() {
        ...
        ctx = new ClassPathXmlApplicationContext(new String[]{"classpath:SpringPropertySourcesPlaceholderConfigurer-composite-config-withstringlocations.xml"});
