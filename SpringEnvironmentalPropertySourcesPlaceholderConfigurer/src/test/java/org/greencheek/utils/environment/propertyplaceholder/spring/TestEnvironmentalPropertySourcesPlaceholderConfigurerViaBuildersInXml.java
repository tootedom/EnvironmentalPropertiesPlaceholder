 ...
 * Time: 13:25
 */
public class TestEnvironmentalPropertySourcesPlaceholderConfigurerViaBuildersInXml {
    ...
    public void testPropertyResolved() {
        ...
        ctx = new ClassPathXmlApplicationContext(new String[]{"classpath:SpringPropertySourcesPlaceholderConfigurer-config.xml"});
