 ...
 * Time: 13:25
 */
public class TestEnvironmentalPropertyPlaceholderConfigurerViaCompositeBuilderInXml {
    ...
    public void testPropertyResolved() {
        ...
        ctx = new ClassPathXmlApplicationContext(new String[]{"classpath:SpringPropertyPlaceholderConfigurer-composite-config-withstringlocations.xml"});
